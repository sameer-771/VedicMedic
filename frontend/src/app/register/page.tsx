    ...
    <div className="min-h-screen bg-[#0a0f1c] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <motion.div className="w-full max-w-md relative z-10" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white font-['Outfit'] mb-2">Create Account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" required className="input-field pl-10" placeholder="Dr. Ayush Kumar" value={form.name} onChange={e => setForm({...form, name: e.target.value})} />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required className="input-field pl-10" placeholder="you@example.com" value={form.email} onChange={e => setForm({...form, email: e.target.value})} />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required minLength={6} className="input-field pl-10" placeholder="••••••••" value={form.password} onChange={e => setForm({...form, password: e.target.value})} />
              </div>
            </div>
            <div>
